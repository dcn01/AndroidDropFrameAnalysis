...
def dumpsysFramestats():
    ...
    profileText = open('./output/C_SlideLargeImage/txt/AllFrame.txt', 'w')
...
def beginProcessResult():
    ...
    profileRead = open('./output/C_SlideLargeImage/txt/AllFrame.txt', 'r')
    ...
    fpsAllFrameRead = open("./output/C_SlideLargeImage/txt/FourFrame.txt", "w")
    for fpsallframe in fpsReadList:
        fpsAllFrameRead.write(fpsallframe)
    profileAllFrameRead = open("./output/C_SlideLargeImage/txt/NineFrame.txt", "w")
    ...
    for line in fpsReadList:
        ...
        recordRow += 1
    wb.save('./output/C_SlideLargeImage/excel/FourFrame.xlsx')
    ...
    for tmplist in fpsReadList:
        ...
        if c == 0:
            fin = fin + "{"
        if c == e - 1:
            fin = fin + str(c) + ":{\"Draw\":" + splitByT[1] + ",\"Prepare\":" + splitByT[2] + ",\"Process\":" + \
                  splitByT[
    ...
    dataWrite = open("./output/C_SlideLargeImage/html/FourFrame/js/data.js", "w")
    dataWrite.write(fin)
    print("FourFrameEnd")
    ...
    frameCount = 25 * e + 50
    fin = "var person_data = " + fin + ";\nvar svg_width = " + str(frameCount) + ";"
    dataWrite = open("./output/C_SlideLargeImage/html/NineFrame/js/data.js", "w")
    dataWrite.write(fin)
    ...
    for tmplist in profileDataReadList:
        ...
        recordRow += 1
    wb.save('./output/C_SlideLargeImage/excel/NineFrame.xlsx')
    print("NineFrameEnd")
